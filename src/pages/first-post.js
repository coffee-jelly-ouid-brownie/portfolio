                ...
                <div className='firstpost--body'>
                    ...
                    <Card className='firstpost--card'>
                        ...
                        <div className='firstpost--content'>
                            <p>
                                This is my first post on this new blog! I've never done any web develop completely from scratch (relying on Google and a lot of trial and error), so this was a great chance to learn more new skills! I'm hoping to use this blog to encourage myself to make and share projects and my interests.
                            </p>
                            <h2>
                            ...
                            <p>
                                This idea of a website blog all began when I wanted to create a quadruped robot (upcoming post!). I wanted a way to share the process and the creation in an interactive way while motivating myself to continue with the project even when it gets challenging. A medium to keep me motivated to develop my coding skills and continue with projects, kills two birds with one stone!
                            </p>
                            <h2>
                                Current state
                            </h2>
                            ...
                            <p>Anyway, expect more posts coming! That's all for now, bye!</p>
                        </div>
                    </Card>
                    {/* Date */}
                    {/* Title of blog page */}
