...
// EXTERNAL MODULE: ./node_modules/baseui/esm/helpers/overrides.js
var helpers_overrides = __webpack_require__(2338);
;// CONCATENATED MODULE: ./node_modules/baseui/esm/heading/heading-level.js
/*
Copyright (c) Uber Technologies, Inc.
...
var LevelContext = /*#__PURE__*/index_js_.createContext(0);
...
/* harmony default export */ const heading_level = ((/* unused pure expression or super */ null && (HeadingLevel)));
// EXTERNAL MODULE: ./node_modules/baseui/esm/styles/styled.js + 15 modules
var styled = __webpack_require__(4572);
// EXTERNAL MODULE: ./node_modules/baseui/esm/styles/util.js
var util = __webpack_require__(8243);
;// CONCATENATED MODULE: ./node_modules/baseui/esm/card/styled-components.js
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
...
var styled_components_Action = (0,styled/* styled */.zo)('div', function (_ref) {
  var $theme = _ref.$theme;
  return _objectSpread({}, $theme.typography.LabelMedium);
});
styled_components_Action.displayName = "Action";
styled_components_Action.displayName = 'Action';
var styled_components_Body = (0,styled/* styled */.zo)('div', function (_ref2) {
  var $theme = _ref2.$theme;
...
styled_components_Body.displayName = "Body";
styled_components_Body.displayName = 'Body';
var styled_components_Contents = (0,styled/* styled */.zo)('div', function (_ref3) {
...
styled_components_Contents.displayName = "Contents";
styled_components_Contents.displayName = 'Contents';
var styled_components_HeaderImage = (0,styled/* styled */.zo)('img', function (_ref4) {
  var $theme = _ref4.$theme;
  return {
...
styled_components_HeaderImage.displayName = "HeaderImage";
styled_components_HeaderImage.displayName = 'HeaderImage'; // by using the section tag, we can keep the h1 for the title
// https://html.spec.whatwg.org/multipage/sections.html#headings-and-sections

var styled_components_Root = (0,styled/* styled */.zo)('section', function (_ref5) {
...
styled_components_Root.displayName = "Root";
styled_components_Root.displayName = 'Root';
var styled_components_Thumbnail = (0,styled/* styled */.zo)('img', function (_ref6) {
  var $theme = _ref6.$theme;
  ...
  }, (0,util/* expandBorderStyles */.Qj)($theme.borders.border200)), {}, {
    margin: "0 0 ".concat($theme.sizing.scale500, " ").concat($theme.sizing.scale500)
  });
});
styled_components_Thumbnail.displayName = "Thumbnail";
styled_components_Thumbnail.displayName = 'Thumbnail';
var Title = (0,styled/* styled */.zo)('h1', function (_ref7) {
  var $theme = _ref7.$theme;
...
Title.displayName = 'Title';
;// CONCATENATED MODULE: ./node_modules/baseui/esm/card/card.js
...
var SemanticTitle = function SemanticTitle(_ref) {
  ...
  return /*#__PURE__*/index_js_.createElement(LevelContext.Consumer, null, function (level) {
    return (
      /*#__PURE__*/
      // @ts-expect-error
      index_js_.createElement(Title, _extends({
        $as: levels[level]
      }, restProps), children)
    );
  });
...
function Card(props) {
  ...
  var Action = (0,helpers_overrides/* getOverride */.XG)(ActionOverride) || styled_components_Action;
  var Body = (0,helpers_overrides/* getOverride */.XG)(BodyOverride) || styled_components_Body;
  var Contents = (0,helpers_overrides/* getOverride */.XG)(ContentsOverride) || styled_components_Contents;
  var HeaderImage = (0,helpers_overrides/* getOverride */.XG)(HeaderImageOverride) || styled_components_HeaderImage;
  var Root = (0,helpers_overrides/* getOverride */.XG)(RootOverride) || styled_components_Root;
  var Thumbnail = (0,helpers_overrides/* getOverride */.XG)(ThumbnailOverride) || styled_components_Thumbnail;
  var Title = (0,helpers_overrides/* getOverride */.XG)(TitleOverride) || SemanticTitle;
  var headerImageProps = typeof headerImage === 'string' ? {
    src: headerImage
  } : headerImage;
  var $hasThumbnail = hasThumbnail(props);
  return /*#__PURE__*/index_js_.createElement(Root, _extends({
    "data-baseweb": "card"
  }, restProps, (0,helpers_overrides/* getOverrideProps */.ch)(RootOverride)), headerImage && /*#__PURE__*/index_js_.createElement(HeaderImage, _extends({}, headerImageProps, (0,helpers_overrides/* getOverrideProps */.ch)(HeaderImageOverride))), /*#__PURE__*/index_js_.createElement(Contents, (0,helpers_overrides/* getOverrideProps */.ch)(ContentsOverride), thumbnailSrc && /*#__PURE__*/index_js_.createElement(Thumbnail, _extends({
    src: thumbnailSrc
  }, (0,helpers_overrides/* getOverrideProps */.ch)(ThumbnailOverride))), title && /*#__PURE__*/index_js_.createElement(Title, _extends({
    $hasThumbnail: $hasThumbnail
  }, (0,helpers_overrides/* getOverrideProps */.ch)(TitleOverride)), title), /*#__PURE__*/index_js_.createElement(Body, (0,helpers_overrides/* getOverrideProps */.ch)(BodyOverride), children), action && /*#__PURE__*/index_js_.createElement(Action, (0,helpers_overrides/* getOverrideProps */.ch)(ActionOverride), action)));
}
...
var Header = __webpack_require__(5526);
// EXTERNAL MODULE: ./src/components/Footer.js + 2 modules
var Footer = __webpack_require__(9249);
// EXTERNAL MODULE: ./node_modules/@mui/icons-material/HourglassBottom.js
var HourglassBottom = __webpack_require__(4239);
...
;// CONCATENATED MODULE: ./src/pages/first-post.js
function FirstPost(){return/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement(Header/* default */.Z,null),/*#__PURE__*/index_js_default().createElement("div",{className:"firstpost--body"},/*#__PURE__*/index_js_default().createElement(card,{className:"firstpost--card"},/*#__PURE__*/index_js_default().createElement("h1",{className:"firstpost--header"},"Website launch - First post!"),/*#__PURE__*/index_js_default().createElement("div",{className:"firstpost--postinfo"},/*#__PURE__*/index_js_default().createElement("div",{className:"firstpost--icon"},/*#__PURE__*/index_js_default().createElement(HourglassBottom/* default */.Z,null),/*#__PURE__*/index_js_default().createElement("p",null,"1 MIN READ")),/*#__PURE__*/index_js_default().createElement("div",{className:"firstpost--icon"},/*#__PURE__*/index_js_default().createElement(CalendarMonth/* default */.Z,null),/*#__PURE__*/index_js_default().createElement("p",null,"14 MARCH 2023"))),/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* StaticImage */.Jv,{className:"firstpost--image",src:"https://images.unsplash.com/photo-1444703686981-a3abbc4d4fe3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80",alt:"First post!",__imageData:__webpack_require__(5075)}),/*#__PURE__*/index_js_default().createElement("div",{className:"firstpost--content"},/*#__PURE__*/index_js_default().createElement("p",null,"This is my first post on this new blog! I've never done any web develop completely from scratch (relying on Google and a lot of trial and error), so this was a great chance to learn more new skills! I'm hoping to use this blog to encourage myself to make and share projects and my interests."),/*#__PURE__*/index_js_default().createElement("h2",null,"Why bother making one?"),/*#__PURE__*/index_js_default().createElement("p",null,"There's many web design templates that are ready-made, flashy designs, professionally done, and can be hosted in only 5 minutes! So, why go through all that effort to make one myself? By creating my own website I feel a sense of ownership and connection to this website that I wouldn't have if I paid for a web template. This will be a website that I have complete control over, able to personalise it to my heart's content"),/*#__PURE__*/index_js_default().createElement("p",null,"This idea of a website blog all began when I wanted to create a quadruped robot (upcoming post!). I wanted a way to share the process and the creation in an interactive way while motivating myself to continue with the project even when it gets challenging. A medium to keep me motivated to develop my coding skills and continue with projects, kills two birds with one stone!"),/*#__PURE__*/index_js_default().createElement("h2",null,"Current state"),/*#__PURE__*/index_js_default().createElement("p",null,"So far, I have the following pages:"),/*#__PURE__*/index_js_default().createElement("li",null,"Welcome page"),/*#__PURE__*/index_js_default().createElement("li",null,"About me"),/*#__PURE__*/index_js_default().createElement("li",null,"Tags (Under development)"),/*#__PURE__*/index_js_default().createElement("p",null,"I did not create a specific page for blog and combined it to be below the hero section of the Welcome page as I feel that is the main focus on my website. This has lead me to consider combining all pages into one so the user wouldn't have to flick between pages, and reduces the need for my page to refresh, increasing the efficiency of my website overall."),/*#__PURE__*/index_js_default().createElement("p",null,"Anyway, expect more posts coming! That's all for now, bye!")))),/*#__PURE__*/index_js_default().createElement(Footer/* default */.Z,null));}const Head=()=>/*#__PURE__*/index_js_default().createElement("title",null,"First post");
