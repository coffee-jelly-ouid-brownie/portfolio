...
function InnerThemeProvider(props) {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)(emotion_element_3838ba9e_esm.T.Provider, {
...
function GlobalStyles(props) {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)(emotion_react_esm/* Global */.xB, {
    styles: globalStyles
  });
}
 false ? 0 : void 0;
...
var useThemeProps_useThemeProps = __webpack_require__(7333);
// EXTERNAL MODULE: ./node_modules/@mui/system/esm/createStyled.js + 1 modules
var createStyled = __webpack_require__(2807);
...
// EXTERNAL MODULE: ./node_modules/@mui/system/esm/createTheme/createTheme.js + 3 modules
var createTheme_createTheme = __webpack_require__(6268);
...
const createContainer_defaultTheme = (0,createTheme_createTheme/* default */.Z)();
...
const useThemePropsDefault = inProps => (0,useThemeProps_useThemeProps/* default */.Z)({
  props: inProps,
  name: 'MuiContainer',
...
// EXTERNAL MODULE: ./node_modules/@mui/material/utils/capitalize.js
var utils_capitalize = __webpack_require__(8216);
...
const Button_useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', variant, `${variant}${(0,utils_capitalize/* default */.Z)(color)}`, `size${(0,utils_capitalize/* default */.Z)(size)}`, `${variant}Size${(0,utils_capitalize/* default */.Z)(size)}`, color === 'inherit' && 'colorInherit', disableElevation && 'disableElevation', fullWidth && 'fullWidth'],
    label: ['label'],
    startIcon: ['startIcon', `iconSize${(0,utils_capitalize/* default */.Z)(size)}`],
    endIcon: ['endIcon', `iconSize${(0,utils_capitalize/* default */.Z)(size)}`]
  };
...
const ButtonRoot = (0,styled/* default */.ZP)(ButtonBase/* default */.Z, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, styles[ownerState.variant], styles[`${ownerState.variant}${(0,utils_capitalize/* default */.Z)(ownerState.color)}`], styles[`size${(0,utils_capitalize/* default */.Z)(ownerState.size)}`], styles[`${ownerState.variant}Size${(0,utils_capitalize/* default */.Z)(ownerState.size)}`], ownerState.color === 'inherit' && styles.colorInherit, ownerState.disableElevation && styles.disableElevation, ownerState.fullWidth && styles.fullWidth];
  }
})(({
  theme,
  ownerState
...
const ButtonStartIcon = (0,styled/* default */.ZP)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.startIcon, styles[`iconSize${(0,utils_capitalize/* default */.Z)(ownerState.size)}`]];
  }
})(({
  ownerState
}) => (0,esm_extends/* default */.Z)({
...
const ButtonEndIcon = (0,styled/* default */.ZP)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.endIcon, styles[`iconSize${(0,utils_capitalize/* default */.Z)(ownerState.size)}`]];
  }
})(({
  ownerState
}) => (0,esm_extends/* default */.Z)({
...
function createBox(options = {}) {
  ...
  const Box = /*#__PURE__*/index_js_.forwardRef(function Box(inProps, ref) {
    const theme = (0,esm_useTheme/* default */.Z)(defaultTheme);
...
var hyphenate_style_name = __webpack_require__(5477);
...
function convertCase(style) {
  ...
  for (var prop in style) {
    var key = prop.indexOf('--') === 0 ? prop : (0,hyphenate_style_name["default"])(prop);
...
function camelCase() {
  ...
  function onChangeValue(value, prop, rule) {
    ...
    var hyphenatedProp = (0,hyphenate_style_name["default"])(prop); // There was no camel case in place
...
const StylesContext = /*#__PURE__*/index_js_.createContext(defaultOptions);
if (false) {}
let injectFirstNode;
...
function propsToClassKey(props) {
  ...
  Object.keys(other).sort().forEach(key => {
    if (key === 'color') {
      classKey += propsToClassKey_isEmpty(classKey) ? props[key] : (0,capitalize/* default */.Z)(props[key]);
    } else {
      classKey += `${propsToClassKey_isEmpty(classKey) ? key : (0,capitalize/* default */.Z)(key)}${(0,capitalize/* default */.Z)(props[key].toString())}`;
    }
  });
  return classKey;
}
...
function useSynchronousEffect(func, values) {
  const key = index_js_.useRef([]);
  let output;

  // Store "generation" key. Just returns a new object every time
  const currentKey = index_js_.useMemo(() => ({}), values); // eslint-disable-line react-hooks/exhaustive-deps
...
function makeStyles(stylesOrCreator, options = {}) {
  ...
  const useStyles = (props = {}) => {
    const theme = (0,useTheme/* default */.Z)() || defaultTheme;
    const stylesOptions = (0,esm_extends/* default */.Z)({}, index_js_.useContext(StylesContext), stylesOptions2);
    const instance = index_js_.useRef();
    const shouldUpdate = index_js_.useRef();
...
const socialItems=[{icon:GitHub/* default */.Z,url:"https://github.com/coffee-jelly-ouid-brownie",label:"Github profile button"},{icon:LinkedIn/* default */.Z,url:"https://www.linkedin.com/in/carys-leung-356837258/",label:"LinkedIn profile button"},{icon:Twitter/* default */.Z,url:"https://twitter.com/CarysLeung",label:"Twitter profile button"}];function Social({direction}){return/*#__PURE__*/index_js_default().createElement(Grid/* default */.ZP,{container:true,direction:direction||"row",spacing:1.5},socialItems.map((item,i)=>/*#__PURE__*/index_js_default().createElement(Grid/* default */.ZP,{item:true,key:i},/*#__PURE__*/index_js_default().createElement(Link/* default */.Z,{"aria-label":item.label,href:item.url,key:i},/*#__PURE__*/index_js_default().createElement(IconButton/* default */.Z,{key:i},/*#__PURE__*/index_js_default().createElement(item.icon,{style:{fontSize:30},key:i}))))));}
...
const useStyles=makeStyles(theme=>({section:{height:"100vh",position:"relative"},content:{height:"100%",zIndex:100,position:"relative"},container:{height:"100%"},overlay:{backgroundColor:"rgba(0,0,0,0.4)",height:"100%",width:"100%",zIndex:2,position:"absolute"},heroImage:{height:"100vh",width:"100%",position:"absolute",zIndex:1}}));function HeroSection(){const styles=useStyles();const{0:shouldShow,1:setShouldShow}=(0,index_js_.useState)(false);(0,index_js_.useEffect)(()=>setShouldShow(true),[]);return/*#__PURE__*/index_js_default().createElement(Paper_Paper,{className:styles.section,id:"about"},/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* StaticImage */.Jv,{className:styles.heroImage,src:"https://images.unsplash.com/photo-1574610758891-5b809b6e6e2e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2676&q=80",alt:"",__imageData:__webpack_require__(411)}),/*#__PURE__*/index_js_default().createElement("div",{className:styles.overlay}),/*#__PURE__*/index_js_default().createElement(Container_Container,{className:styles.container,maxWidth:"md"},/*#__PURE__*/index_js_default().createElement(Grid/* default */.ZP,{className:styles.content,container:true,justifyContent:"space-between",alignItems:"center"},/*#__PURE__*/index_js_default().createElement(Zoom_Zoom,{in:shouldShow},/*#__PURE__*/index_js_default().createElement(Grid/* default */.ZP,{item:true,sm:8},/*#__PURE__*/index_js_default().createElement("h1",{className:"hero--welcome"},"Hi, I'm Carys Leung."),/*#__PURE__*/index_js_default().createElement("h4",{className:"hero--text"},"I build things! I'm a student and an aspiring engineer. This is where I share what I'm working on and stuff I'm interested in :)"),/*#__PURE__*/index_js_default().createElement(Box_Box,{my:2},/*#__PURE__*/index_js_default().createElement(Button_Button,{href:"mailto:caryshcleung@gmail.com",variant:"outlined",color:"secondary",style:{color:'#C1A8D2'}},"Get in touch!")))),/*#__PURE__*/index_js_default().createElement(Grid/* default */.ZP,{item:true},/*#__PURE__*/index_js_default().createElement(Social,{direction:"column"})))));}
// EXTERNAL MODULE: ./node_modules/@mui/icons-material/OpenInNew.js
var OpenInNew = __webpack_require__(4048);
...
const Chip_useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', variant, disabled && 'disabled', `size${(0,utils_capitalize/* default */.Z)(size)}`, `color${(0,utils_capitalize/* default */.Z)(color)}`, clickable && 'clickable', clickable && `clickableColor${(0,utils_capitalize/* default */.Z)(color)}`, onDelete && 'deletable', onDelete && `deletableColor${(0,utils_capitalize/* default */.Z)(color)}`, `${variant}${(0,utils_capitalize/* default */.Z)(color)}`],
    label: ['label', `label${(0,utils_capitalize/* default */.Z)(size)}`],
    avatar: ['avatar', `avatar${(0,utils_capitalize/* default */.Z)(size)}`, `avatarColor${(0,utils_capitalize/* default */.Z)(color)}`],
    icon: ['icon', `icon${(0,utils_capitalize/* default */.Z)(size)}`, `iconColor${(0,utils_capitalize/* default */.Z)(iconColor)}`],
    deleteIcon: ['deleteIcon', `deleteIcon${(0,utils_capitalize/* default */.Z)(size)}`, `deleteIconColor${(0,utils_capitalize/* default */.Z)(color)}`, `deleteIcon${(0,utils_capitalize/* default */.Z)(variant)}Color${(0,utils_capitalize/* default */.Z)(color)}`]
  };
...
const ChipRoot = (0,styled/* default */.ZP)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [{
      ...
      [`& .${Chip_chipClasses.avatar}`]: styles[`avatar${(0,utils_capitalize/* default */.Z)(size)}`]
    }, {
      [`& .${Chip_chipClasses.avatar}`]: styles[`avatarColor${(0,utils_capitalize/* default */.Z)(color)}`]
    }, {
      [`& .${Chip_chipClasses.icon}`]: styles.icon
    }, {
      [`& .${Chip_chipClasses.icon}`]: styles[`icon${(0,utils_capitalize/* default */.Z)(size)}`]
    }, {
      [`& .${Chip_chipClasses.icon}`]: styles[`iconColor${(0,utils_capitalize/* default */.Z)(iconColor)}`]
    }, {
      [`& .${Chip_chipClasses.deleteIcon}`]: styles.deleteIcon
    }, {
      [`& .${Chip_chipClasses.deleteIcon}`]: styles[`deleteIcon${(0,utils_capitalize/* default */.Z)(size)}`]
    }, {
      [`& .${Chip_chipClasses.deleteIcon}`]: styles[`deleteIconColor${(0,utils_capitalize/* default */.Z)(color)}`]
    }, {
      [`& .${Chip_chipClasses.deleteIcon}`]: styles[`deleteIcon${(0,utils_capitalize/* default */.Z)(variant)}Color${(0,utils_capitalize/* default */.Z)(color)}`]
    }, styles.root, styles[`size${(0,utils_capitalize/* default */.Z)(size)}`], styles[`color${(0,utils_capitalize/* default */.Z)(color)}`], clickable && styles.clickable, clickable && color !== 'default' && styles[`clickableColor${(0,utils_capitalize/* default */.Z)(color)})`], onDelete && styles.deletable, onDelete && color !== 'default' && styles[`deletableColor${(0,utils_capitalize/* default */.Z)(color)}`], styles[variant], styles[`${variant}${(0,utils_capitalize/* default */.Z)(color)}`]];
  }
})(({
  theme,
  ownerState
...
const ChipLabel = (0,styled/* default */.ZP)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.label, styles[`label${(0,utils_capitalize/* default */.Z)(size)}`]];
  }
})(({
  ownerState
}) => (0,esm_extends/* default */.Z)({
...
const Projects_useStyles=makeStyles(theme=>({cardMedia:{width:"100%",height:300},icons:{marginBottom:"10px"},links:{marginRight:"auto"},tag:{marginRight:5,marginBottom:5}}));function Project({title,description,imageUrl,tags,links,pagehref}){const styles=Projects_useStyles();return/*#__PURE__*/index_js_default().createElement(Grid/* default */.ZP,{item:true},/*#__PURE__*/index_js_default().createElement(Card_Card,{className:"blog--card"},/*#__PURE__*/index_js_default().createElement(CardActionArea_CardActionArea,null,/*#__PURE__*/index_js_default().createElement("div",null,pagehref===null||pagehref===void 0?void 0:pagehref.map(pages=>/*#__PURE__*/index_js_default().createElement(Link/* default */.Z,{href:pages.href,key:pages.href,style:{color:'white'},underline:"none"},/*#__PURE__*/index_js_default().createElement(CardMedia_CardMedia,{className:styles.cardMedia,image:imageUrl}),/*#__PURE__*/index_js_default().createElement(CardContent_CardContent,null,/*#__PURE__*/index_js_default().createElement("h2",{className:"blog--title"},title),/*#__PURE__*/index_js_default().createElement("p",{className:"blog--description"},description)))))),/*#__PURE__*/index_js_default().createElement(CardActions_CardActions,{className:styles.icons},/*#__PURE__*/index_js_default().createElement("div",{className:styles.links},links.map(linkItem=>/*#__PURE__*/index_js_default().createElement(IconButton/* default */.Z,{href:linkItem.href,key:linkItem.href},/*#__PURE__*/index_js_default().createElement(linkItem.icon,null)))),/*#__PURE__*/index_js_default().createElement("div",null,tags.map(tag=>/*#__PURE__*/index_js_default().createElement(Chip_Chip,{className:styles.tag,label:tag,variant:"outlined",key:tag}))))));}function Projects(){return/*#__PURE__*/index_js_default().createElement(Container_Container,{maxWidth:"md",id:"projects"},/*#__PURE__*/index_js_default().createElement(Box_Box,{pt:8,mb:2},/*#__PURE__*/index_js_default().createElement("h1",{className:"projects--header"},"Projects")),/*#__PURE__*/index_js_default().createElement(Grid/* default */.ZP,{container:true,direction:"column",spacing:4},projectsData.map(data=>/*#__PURE__*/index_js_default().createElement(Project,Object.assign({},data,{key:data.title})))));}const projectsData=[{title:"Website launch!",description:"This is my first post on this new blog! I've never done any web development before, so this is will be a good chance to learn some new stuff! A quick read into the future of this blog and what I'll be sharing :)",imageUrl:"https://images.unsplash.com/photo-1444703686981-a3abbc4d4fe3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80",imageAlt:"Project 1 Image",tags:["React.js","Material-UI","Gatsby.js"],links:[{icon:OpenInNew/* default */.Z,href:"/first-post"}],pagehref:[{href:"/first-post"}]},{title:"Lorem ipsum dolor sit amet",description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco",imageAlt:"Project 2 Image",imageUrl:"https://images.unsplash.com/photo-1433086966358-54859d0ed716?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=687&q=80",tags:["GraphQL","Apollo Client","Prisma","Material-UI"],links:[{icon:GitHub/* default */.Z,href:"https://www.github.com"},{icon:OpenInNew/* default */.Z,href:"https://www.google.com"}],pagehref:[{href:"/about"}]},{title:"Lorem ipsum dolor ",description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco",imageAlt:"Project 3 Image",imageUrl:"https://images.unsplash.com/photo-1606214174585-fe31582dc6ee?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80",tags:["React.js","Node.js","PostgreSQL","Next.js"],links:[{icon:OpenInNew/* default */.Z,href:"https://www.google.com"}],pagehref:[{href:"/about"}]}];
// EXTERNAL MODULE: ./src/components/Footer.js + 2 modules
var Footer = __webpack_require__(9249);
;// CONCATENATED MODULE: ./src/pages/index.js
let darkTheme=(0,createTheme/* default */.Z)({palette:{mode:"dark"}});darkTheme=responsiveFontSizes(darkTheme);function IndexPage(){(0,index_js_.useEffect)(()=>{document.title='Carys Leung';},[]);return/*#__PURE__*/index_js_default().createElement(esm_ThemeProvider_ThemeProvider,{theme:darkTheme},/*#__PURE__*/index_js_default().createElement(CssBaseline_CssBaseline,null),/*#__PURE__*/index_js_default().createElement(HeroSection,null),/*#__PURE__*/index_js_default().createElement(Projects,null),/*#__PURE__*/index_js_default().createElement(Footer/* default */.Z,null));}
...
*/
var aa=__webpack_require__(3797),ca=__webpack_require__(3840);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
"use strict";
module.exports = JSON.parse('{"layout":"constrained","backgroundColor":"#080808","images":{"fallback":{"src":"/static/b9eaf7194062f6c3bc6c118b7cc9d1ee/b496c/photo-1574610758891-5b809b6e6e2e.jpg","srcSet":"/static/b9eaf7194062f6c3bc6c118b7cc9d1ee/ff107/photo-1574610758891-5b809b6e6e2e.jpg 669w,\\n/static/b9eaf7194062f6c3bc6c118b7cc9d1ee/ff0e9/photo-1574610758891-5b809b6e6e2e.jpg 1338w,\\n/static/b9eaf7194062f6c3bc6c118b7cc9d1ee/b496c/photo-1574610758891-5b809b6e6e2e.jpg 2676w","sizes":"(min-width: 2676px) 2676px, 100vw"},"sources":[{"srcSet":"/static/b9eaf7194062f6c3bc6c118b7cc9d1ee/907d9/photo-1574610758891-5b809b6e6e2e.webp 669w,\\n/static/b9eaf7194062f6c3bc6c118b7cc9d1ee/68f6d/photo-1574610758891-5b809b6e6e2e.webp 1338w,\\n/static/b9eaf7194062f6c3bc6c118b7cc9d1ee/cd930/photo-1574610758891-5b809b6e6e2e.webp 2676w","type":"image/webp","sizes":"(min-width: 2676px) 2676px, 100vw"}]},"width":2676,"height":1772}');
